...
class MovieListsSheet extends StatelessWidget {
  const MovieListsSheet({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: listsAsync.when(
        ...
        data: (data) {
          final lists = data.lists.where((l) => !BuiltInMovieLists.isBuiltIn(l.id)).toList();
          return Column(
            ...
            children: [
              ...
              Text(
                'Add this movie to one or more personal lists.',
