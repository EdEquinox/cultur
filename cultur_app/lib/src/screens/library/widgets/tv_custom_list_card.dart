...
class TvCustomListCard extends StatelessWidget {
  const TvCustomListCard({super.key, required this.list, this.onTap});

  final TvCustomList list;
                ...
                SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      final row = list.items[index];
                      return LibraryPosterThumb(
                        imageUrl: row.show.imageUrl,
                        width: 54,
                        height: 82,
                      );
                    },
