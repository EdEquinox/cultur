...
import 'package:yamtrack/src/screens/widgets/cultur_detail_action_row.dart';

/// Album detail actions — Lists, Rate, Later, Follow, Buy, Owned (mockup layout).
class AlbumActionRow extends StatelessWidget {
    ...
    return CulturDetailActionRow(
      ...
      tiles: [
        ...
        CulturDetailActionTileSpec.toggle(
          ...
          tooltip: isFollowing ? 'Following artist' : 'Follow artist',
