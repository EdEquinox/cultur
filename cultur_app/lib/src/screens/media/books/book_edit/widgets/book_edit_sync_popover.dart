...
/// Compact picker for API-sourced values (mockup popover over sync icon).
class BookEditSyncPopover extends ConsumerStatefulWidget {
  const BookEditSyncPopover({
  ...
  @override
  ConsumerState<BookEditSyncPopover> createState() => _BookEditSyncPopoverState();
}

class _BookEditSyncPopoverState extends ConsumerState<BookEditSyncPopover> {
  bool _loading = true;
  ...
  Color _providerAccent(BuildContext context, String provider) {
    ...
    return switch (base) {
      'openlibrary' => const Color(0xFF4A9FD4),
      'hardcover' => const Color(0xFF7B6FD6),
      'porbase' => const Color(0xFF3D9A6E),
          ...
          children: [
            ...
            Positioned(
              ...
              child: CustomPaint(
                ...
                painter: _CornerFoldPainter(accent),
              ),
            ),
          ],
        ),
...
Future<BookFieldOption?> showBookEditSyncPopover(
  ...
  return showDialog<BookFieldOption>(
    context: context,
    builder: (dialogContext) => BookEditSyncPopover(
      mediaId: mediaId,
      field: field,
      lookup: lookup,
    ),
